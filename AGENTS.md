...
- For Facebook cookie/session issues, read the `Cookie normalization and Dolphin imports` section in `SESSION_CONTEXT.md` before touching `import_data.py`, `worker.py`, or cookie-related API routes.
...
- If you materially change live operational behavior or discover important runtime quirks during debugging, append the finding to `SESSION_CONTEXT.md` before ending the task.
